...
parser.add_argument('--output_dir', type=str, default="wide_baseline_7_chest_xray/")
...
tv_filename = "wide_baseline_7_" + cfg.model_name + "-" + str(cfg.batch_size) + "-" + str(cfg.num_batches) + "_trainVal_results.csv"
...
model.load_state_dict(torch.load("wide_baseline_7_chest_xray/cx_mc-wideresnet50_2-valid-best.pt").state_dict())
model = model.to(device)
...
test_filename = "wide_baseline_7_" + cfg.model_name + "-" + str(cfg.batch_size) + "-" + str(cfg.num_batches) + "_test_results.csv"
